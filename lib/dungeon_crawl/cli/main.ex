defmodule DungeonCrawl.CLI.Main do
  ...
  defp crawl(character, rooms) do
    Shell.info("You keep moving forward to the next romm.")
    Shell.prompt("Press Enter to continute")
    Shell.cmd("clear")
  ...
  defp handle_action_result({character, _}),
    ...
    defp crawl(%{hit_points: 0}, _) do
      Shell.prompt("")
      Shell.cmd("clear")
      Shell.info("Unfortunatelu your wound are too many to keep walking. ")
      Shell.info("You fall onto the floor without strenght to carry on. ")
